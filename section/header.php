<?php
include $_SERVER['DOCUMENT_ROOT'].'/config/app_config.php';
...
<link rel="stylesheet" href="<?php echo $_SERVER['DOCUMENT_ROOT']; ?>/lib/css/fontello/animation.css">
<link rel="stylesheet" href="<?php echo $_SERVER['DOCUMENT_ROOT']; ?>/lib/css/fontello/fontello.css">
...
<script type="text/javascript" src="<?php echo $_SERVER['DOCUMENT_ROOT']; ?>/lib/js/script.js<?php echo "?v=".rand(100000000, 999999999);  ?> "></script>
 <script type="text/javascript" src="<?php echo $_SERVER['DOCUMENT_ROOT']; ?>/lib/js/socket.js<?php echo "?v=".rand(100000000, 999999999);  ?> "></script>
<!-- <script type="text/javascript" src="<?php echo $_SERVER['DOCUMENT_ROOT']; ?>/lib/js/ajx.js"></script> -->
